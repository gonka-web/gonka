...
Go [here](/host/access-account/) to learn how to access your account. 
...
Go [here](/developer/quickstart/) to set up the CLI and access your account.

Once you have access to your account, return to this guide to learn how to:

- [Query Balance](/wallet/wallet-and-transfer-guide/#query-balance)
- [Send Coins](/wallet/wallet-and-transfer-guide/#send-coins)
- [Check Transaction Status](/wallet/wallet-and-transfer-guide/#check-transaction-status)
