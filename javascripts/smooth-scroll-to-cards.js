...
(function () {
  function init() {
    ...
    setTimeout(function () {
      ...
      heroTriggers.forEach(function (el, index) {
        console.log('Setting up tooltip', index, ':', el.textContent.trim(), 'element:', el);
        el.addEventListener('click', function (e) {
          console.log('Tooltip clicked:', this.textContent.trim());
